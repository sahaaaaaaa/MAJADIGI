...
class KategoriLayananScreen extends StatefulWidget {
  final String kategori;

  const KategoriLayananScreen({super.key, required this.kategori});

  @override
  State<KategoriLayananScreen> createState() => _KategoriLayananScreenState();
}

class _KategoriLayananScreenState extends State<KategoriLayananScreen> {
  ...
  List<LayananModel> get _filteredServices {
    return _services
        .where((item) => _categoryName(item) == widget.kategori)
        .toList();
  }
