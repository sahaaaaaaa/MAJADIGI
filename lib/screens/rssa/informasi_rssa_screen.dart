...
class InformasiRssaScreen extends StatefulWidget {
  ...
  @override
  State<InformasiRssaScreen> createState() => _InformasiRssaScreenState();
}

class _InformasiRssaScreenState extends State<InformasiRssaScreen> {
          ...
          GestureDetector(
            ...
            child: Row(
              children: [
                ...
                Icon(isOpen ? Icons.remove : Icons.add, size: 24),
              ],
            ),
          ),
